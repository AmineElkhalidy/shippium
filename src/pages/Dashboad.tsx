      ...
      <div className="grid lg:grid-cols-2 gap-4 mt-8">
        <div className="border border-slate-200 rounded-md">
          <div className="bg-slate-100 p-6 ">
            <div className="flex justify-between items-center">
              <h3 className="text-dark font-semibold">Delayed packages</h3>
          ...
          <div>
            <div className="grid grid-cols-dashlet gap-2 p-6 border-b">
              <h5 className="font-semibold text-dark">Destination</h5>
              <h5 className="font-semibold text-dark">Truck</h5>
              <h5 className="font-semibold text-dark">Time arrive</h5>
              <h5 className="font-semibold text-dark">Time delay</h5>
            </div>
